...
import pytest
from physkit.physkit_datasets.loaders.base_loader import (
    detect_answer_type,
    is_pure_number,
...
class TestAnswerTypeDetection:
    ...
    def test_detect_answer_type_textual(self):
        ...
        assert detect_answer_type("The solution involves multiple steps") == AnswerType.TEXTUAL
        # Test that pure text without math indicators is textual
        assert detect_answer_type("Explanation of the physics concept") == AnswerType.TEXTUAL
