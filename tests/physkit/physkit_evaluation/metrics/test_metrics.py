...
from physkit.physkit_evaluation.metrics import AccuracyMetric, BaseMetric
from physkit.physkit_evaluation.comparison import SmartAnswerComparator
...
class TestBaseMetric:
    ...
    def test_base_metric_validate_inputs_not_answers(self):
        ...
        with pytest.raises(ValueError, match="not an Answer instance"):
            metric.validate_inputs(["not an answer"], [Answer(value=1, answer_type=AnswerType.NUMERICAL)])
