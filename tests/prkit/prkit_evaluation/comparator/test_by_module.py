"""Tests for :mod:`prkit.prkit_evaluation.comparator.by_module`."""

from __future__ import annotations

import pytest

from prkit.prkit_evaluation.comparator.by_module import (
    build_comparator,
...
from prkit.prkit_evaluation.comparator.typed_llm import TypedLLMComparator
