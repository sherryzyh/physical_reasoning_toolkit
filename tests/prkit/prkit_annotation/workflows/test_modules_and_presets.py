...
from prkit.prkit_annotation.workflows.modules.detect_theorem_module import (
    DetectTheoremModule,
)
from prkit.prkit_annotation.workflows.modules.domain_assessment_module import (
    DomainAssessmentModule,
)
from prkit.prkit_annotation.workflows.modules.review_theorem_module import (
    ReviewTheoremModule,
)
from prkit.prkit_annotation.workflows.presets.domain_only_workflow import (
    DomainOnlyWorkflow,
)
from prkit.prkit_annotation.workflows.presets.theorem_label_only_workflow import (
...
@patch("prkit.prkit_annotation.workflows.modules.detect_theorem_module.TheoremDetector")
...
@patch("prkit.prkit_annotation.workflows.modules.domain_assessment_module.DomainLabeler")
...
@patch("prkit.prkit_annotation.workflows.modules.review_theorem_module.TheoremDetector")
...
def test_domain_only_workflow_uses_patched_composer_and_module(monkeypatch, tmp_path):
    fake_module = object()
    monkeypatch.setattr(
        "prkit.prkit_annotation.workflows.presets.domain_only_workflow.WorkflowComposer",
        FakeComposer,
    )
    monkeypatch.setattr(
        "prkit.prkit_annotation.workflows.presets.domain_only_workflow.DomainAssessmentModule",
...
def test_theorem_label_only_workflow_uses_patched_composer_and_module(monkeypatch, tmp_path):
    fake_module = object()
    monkeypatch.setattr(
        "prkit.prkit_annotation.workflows.presets.theorem_label_only_workflow.WorkflowComposer",
        FakeComposer,
    )
    monkeypatch.setattr(
        "prkit.prkit_annotation.workflows.presets.theorem_label_only_workflow.DetectTheoremModule",
