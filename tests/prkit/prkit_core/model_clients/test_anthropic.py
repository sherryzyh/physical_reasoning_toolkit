...
from prkit.prkit_core.model_clients.anthropic import (
    AnthropicModel,
...
class TestAnthropicModel:
    ...
    @patch("prkit.prkit_core.model_clients.anthropic.encode_image_to_base64")
    @patch("prkit.prkit_core.model_clients.anthropic.os.path.exists")
    @patch("prkit.prkit_core.model_clients.anthropic.Anthropic")
    ...
    def test_init_raises_when_anthropic_package_missing(self, _mock_load_project_dotenv):
        with patch("prkit.prkit_core.model_clients.anthropic.Anthropic", None):
