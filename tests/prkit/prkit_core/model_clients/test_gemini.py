...
from prkit.prkit_core.model_clients.gemini import (
    GeminiModel,
...
class TestGeminiModel:
    ...
    @patch("prkit.prkit_core.model_clients.gemini.normalize_response_format")
    @patch("prkit.prkit_core.model_clients.gemini.extract_schema_for_gemini")
    @patch("prkit.prkit_core.model_clients.gemini.PIL.Image.open")
    @patch("prkit.prkit_core.model_clients.gemini.os.path.exists")
    @patch("prkit.prkit_core.model_clients.gemini.genai")
