...
class TestPhysicsProblem:
    ...
    def test_problem_domain_conversion(self):
        ...
        problem = PhysicsProblem(
            problem_id="test_001", question="Test", domain="classical_mechanics"
        )
        assert (
            isinstance(problem.domain, PhysicsDomain)
            or problem.domain == "classical_mechanics"
        )
    ...
    def test_problem_image_path_normalization(self):
        ...
        problem = PhysicsProblem(
            problem_id="test_001", question="Test", image_path="/path/to/image.jpg"
        )
    ...
    def test_problem_type_validation(self):
        ...
        # Valid types
        problem_mc = PhysicsProblem(
            problem_id="test_001", question="Test", problem_type="MC"
        )
        assert problem_mc.problem_type == "MC"

        problem_oe = PhysicsProblem(
            problem_id="test_002", question="Test", problem_type="OE"
        )
        ...
        with pytest.raises(ValueError):
            PhysicsProblem(
                problem_id="test_003", question="Test", problem_type="INVALID"
            )
    ...
    def test_problem_open_ended(self):
        ...
        problem = PhysicsProblem(
            problem_id="test_001", question="What is F=ma?", problem_type="OE"
        )
    ...
    def test_problem_has_solution(self):
        ...
        problem_with_solution = PhysicsProblem(
            problem_id="test_001", question="Test", solution="This is a solution"
        )
        assert problem_with_solution.has_solution() is True

        problem_without_solution = PhysicsProblem(
            problem_id="test_002", question="Test"
        )
    ...
    def test_problem_display(self):
        ...
        problem = PhysicsProblem(
            problem_id="test_001", question="Test question", solution="Test solution"
        )
