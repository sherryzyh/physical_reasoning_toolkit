...
```python
from physkit_core.definitions.answer_types import SymbolicAnswer, NumericalAnswer
...
- **Core**: Uses `physkit_core.definitions.answer_types` for answer type definitions
