...
:class:`~prkit.evaluation.comparator.smart_match.SmartMatchComparator`
cross-type matching. Used by :class:`~prkit.evaluation.comparator.smart_match.SmartMatchComparator`
...
from prkit.evaluation.utils.compare_cross_type import extract_rhs_and_category
...
def run_smart_pipeline(
    ...
    Implemented against :class:`~prkit.evaluation.comparator.smart_match.SmartMatchComparator`
