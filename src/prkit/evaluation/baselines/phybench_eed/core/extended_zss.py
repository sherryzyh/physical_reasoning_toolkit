#!/usr/bin/env python
# -*- coding: utf-8 -*-
# Vendored from https://github.com/phybench-official/phybench@706feb4 (EED/extended_zss.py),
# MIT. Local modification: none (verbatim). See ../LICENSE and ../PROVENANCE.md.
