# Vendored from https://github.com/phybench-official/phybench@706feb4
# (EED/latex_pre_process.py), MIT. Local modification: none (verbatim).
# See ../LICENSE and ../PROVENANCE.md.
