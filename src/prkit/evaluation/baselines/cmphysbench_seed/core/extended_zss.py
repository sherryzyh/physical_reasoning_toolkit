#!/usr/bin/env python
# -*- coding: utf-8 -*-
# Vendored from https://github.com/CMPhysBench/CMPhysBench@b2cd857 (SEED/extended_zss.py),
# Apache-2.0 (derives from the zss package, BSD). Local modification: none (verbatim).
# See ../LICENSE, ../NOTICE and ../PROVENANCE.md.
