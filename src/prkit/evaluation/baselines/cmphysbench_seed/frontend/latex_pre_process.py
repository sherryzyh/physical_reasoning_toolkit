# Vendored from https://github.com/CMPhysBench/CMPhysBench@b2cd857
# (SEED/latex_pre_process.py), Apache-2.0. Local modification: replaced the SIGALRM
# `timeout_decorator` bound on `master_convert` with the thread-safe
# `prkit.evaluation.edit_distance.timeout.run_with_timeout`. See ../LICENSE,
...
def master_convert_with_timeout(s, t):
    return run_with_timeout(lambda: _master_convert(s, t), timeout_s=10)
