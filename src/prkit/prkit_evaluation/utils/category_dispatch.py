...
This is a small helper used by :class:`~prkit.prkit_evaluation.comparator.smart_match.SmartMatchComparator`,
:class:`~prkit.prkit_evaluation.comparator.category_match.CategoryComparator`, and
:class:`~prkit.prkit_evaluation.comparator.typed_llm.TypedLLMComparator` where the SmartMatch-style
path applies: pick a per-:class:`~prkit.prkit_core.domain.answer_category.AnswerCategory` compare
...
from prkit.prkit_evaluation.utils.compare_same_type import compare_plain_text
from prkit.prkit_evaluation.utils.normalization import normalize_text
...
def compare_by_category(
    ...
    For :attr:`AnswerCategory.TEXT`, applies :func:`~prkit.prkit_evaluation.utils.normalization.normalize_text`
    to both sides before dispatching. Unknown categories fall back to
    :func:`~prkit.prkit_evaluation.utils.compare_same_type.compare_plain_text`.
