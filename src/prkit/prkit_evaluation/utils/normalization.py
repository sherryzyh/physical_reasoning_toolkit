...
`prkit_semantics` owns the normalization logic. This module preserves the
...
from prkit.prkit_semantics.normalization.atomic_kinds import (
    NormalizedAtomicKind,
)
from prkit.prkit_semantics.normalization.atomic_normalization import (
    normalize_answer as _semantics_normalize_answer,
    normalize_expression as _semantics_normalize_expression,
    normalize_number,
)
from prkit.prkit_semantics.normalization.math_text_normalization import (
...
def classify_expression(clean_str: str) -> str:
    ...
    from prkit.prkit_semantics.normalization.expression_normalization import (
