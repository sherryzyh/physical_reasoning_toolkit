...
class NumericalComparator(BaseComparator):
    ...
    def compare(self, answer1: Answer, answer2: Answer) -> Dict[str, Any]:
        ...
        if not self.can_compare(answer1, answer2):
            raise ValueError(
                "Cannot compare non-numerical answers with NumericalComparator"
            )
    ...
    def _is_special_case(self, val1: float, val2: float) -> bool:
        ...
        return (
            math.isnan(val1) or math.isnan(val2) or math.isinf(val1) or math.isinf(val2)
        )
    ...
    def _compare_with_significant_figures(
    ...
    def can_compare(self, answer1: Answer, answer2: Answer) -> bool:
        ...
        return (
            ...
            and answer1.answer_type == AnswerType.NUMERICAL
            and answer2.answer_type == AnswerType.NUMERICAL
        )
