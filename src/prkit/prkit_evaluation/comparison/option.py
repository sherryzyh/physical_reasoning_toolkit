...
class OptionComparator(BaseComparator):
    ...
    def can_compare(self, answer1: Answer, answer2: Answer) -> bool:
        ...
        return (
            answer1.answer_type == AnswerType.OPTION
            and answer2.answer_type == AnswerType.OPTION
        )
    ...
    def compare(self, answer1: Answer, answer2: Answer) -> Dict[str, Any]:
        ...
        details = {
            ...
            "is_multiple_choice": self._is_multiple_choice(ans1_str)
            or self._is_multiple_choice(ans2_str),
    ...
    def compare_with_tolerance(
        ...
        details = {
            ...
            "case_sensitive": case_sensitive,
            "order_sensitive": order_sensitive,
            "is_multiple_choice": self._is_multiple_choice(str(answer1.value))
            or self._is_multiple_choice(str(answer2.value)),
        }
