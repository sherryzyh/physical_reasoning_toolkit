...
The loader automatically determines problem types and maps JEEBench fields to standard PhysKit fields.
...
class JEEBenchLoader(BaseDatasetLoader):
    ...
    def description(self) -> str:
        return (
            "JEEBench: JEE Advanced examination problems across Physics, Chemistry, and Mathematics"
        )
    ...
    def field_mapping(self) -> Dict[str, str]:
        """
        Define field mapping from JEEBench fields to standard PhysKit fields.
        ...
        **kwargs,
        ...
        for problem_data in filtered_data:
            try:
                ...
                self.logger.warning(f"Skipping problem {problem_data.get('index', 'unknown')}: {e}")
                continue
    ...
    def _process_metadata(self, metadata: Dict[str, Any]) -> Dict[str, Any]:
        ...
        metadata["problem_id"] = f"{metadata['subject']}_{metadata['index']}_{metadata['description']}"
    ...
    def get_subject_statistics(self, data_dir: Union[str, Path, None] = None) -> Dict[str, Any]:
    ...
    def list_available_subjects(self, data_dir: Union[str, Path, None] = None) -> List[str]:
